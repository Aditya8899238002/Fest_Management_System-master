...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/VGI logo.jpg">  
    <!-- icon shown on top of heading of admin page  -->
    <style>
...
<div class="wrapper fadeInDown">
    ...
    <div id="formContent">
      ...
      <div class="fadeIn first">
        ...
        <img src="images/VGI logo.jpg"  height ="100" width="100" alt="vgi logo">
      </div>
