        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-10 col-lg-4">
              ...
              <!-- to go to SE website -->
                <a href="https://www.vgi.ac.in/se">festinexus
                    </a>
            ...
            <div class="col-2 col-lg-8">
              <nav class="site-navigation">
                ...
                <!-- nav bar URLS to go to different pages -->
                   <li><a href=""><i class="bi bi-broadcast-pin"></i><br>Live stream</a></li>
                  ...
                  <li><a href="plogin.php">You'r in festinexus</a></li>
        ...
        <div class="col-12">
          <div class="lineup-artists-headline">
            ...
            <div class="lineup-artists">
              ...
              <div class="lineup-artists-wrap flex flex-wrap">
                <div class="lineup-artists-description">
                  <figure class="featured-image d-md-none">
                    <a href="#">
                      <img src="images/Vishal Mishra.jpg" alt="" />
                    </a>
                  </figure>
                  <!-- featured-image -->
              ...
              <div class="lineup-artists-wrap flex flex-wrap">
                <figure class="featured-image">
                  <a href="#"> <img src="images/D.J Chetas.jpg" alt="" /> </a>
                </figure>
                <!-- featured-image -->
          ...
          <div class="the-complete-lineup">
            ...
            <div class="row the-complete-lineup-artists">
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/deep.jpeg" alt="" /> </a>
              ...
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/sonam.jpg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
              ...
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/varun.jpeg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
              ...
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/akshay.jpeg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
              ...
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/tiger.jpeg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
              ...
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/sidhrt.jpeg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
                ...
                <h2>Sidhhart Malhotra</h2>
              </div>
              <!-- artist-single -->

              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/ajay.jpeg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
              ...
              <div class="col-6 col-md-4 col-lg-3 artist-single">
                <figure class="featured-image">
                  <a href="#"> <img src="images/rahman.jpeg" alt="" /> </a>
                  <a href="#" class="box-link">
                    <img src="images/box.jpg" alt="" />
                  </a>
                </figure>
...
<!-- sponsors begin -->
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="copyright-info">
                ...
                <a href="mainpage.php" target="_blank">Jeevan and Kaushik</a>
              </div>
              ...
              <div class="footer-social">
                <ul class="flex justify-content-center align-items-center">
                  ...
                  <li>
                    <a href="https://www.facebook.com/vgi.greaternoida/"><i class="fab fa-facebook-f"></i></a>
                  </li>
                  <li>
                    <a href="https://twitter.com/vgigreaternoida"><i class="fab fa-twitter"></i></a>
                  </li>
                  
                  
                  <li>
                    <a href="https://in.linkedin.com/school/vishveshwarya/"><i class="fab fa-linkedin-in"></i></a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    // script for countdown
      ...
      var countDownDate = new Date("June 11, 2024 00:00:00").getTime();
